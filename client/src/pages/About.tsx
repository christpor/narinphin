...
export default function About() {
  return <><Seo route="/about" /><PageHero number="01" eyebrow="About Narin" khmer="អំពីគ្រូណារិន" title="An educator shaped by classrooms, communities, and continual learning." intro="A professional profile built around English education, academic leadership, and a belief that language opens practical pathways." khmerTitle="គ្រូបង្រៀនដែលរីកចម្រើនតាមរយៈថ្នាក់រៀន សហគមន៍ និងការរៀនជាបន្តបន្ទាប់។" khmerIntro="ទស្សនៈវិជ្ជាជីវៈផ្អែកលើការបង្រៀនភាសាអង់គ្លេស ភាពជាអ្នកដឹកនាំ និងការប្រើភាសាដើម្បីបើកផ្លូវថ្មីៗ។" image={ASSETS.portrait} imageAlt="Narin Phin in a formal professional portrait" />
