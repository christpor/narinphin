...
export default function Contact() {
  return <><Seo route="/contact" /><PageHero number="05" eyebrow="Contact" khmer="ទំនាក់ទំនង" title="A good conversation is a strong place to begin." intro="For teaching, curriculum, academic leadership, and educational collaboration enquiries, write to Narin directly." khmerTitle="ការសន្ទនាល្អ គឺជាចំណុចចាប់ផ្តើមដ៏រឹងមាំ។" khmerIntro="សម្រាប់ការសាកសួរអំពីការបង្រៀន កម្មវិធីសិក្សា ភាពជាអ្នកដឹកនាំ និងកិច្ចសហការផ្នែកអប់រំ សូមសរសេរមកគ្រូណារិនដោយផ្ទាល់។" image={ASSETS.portraitSquare} imageAlt="Narin Phin in a professional profile portrait" />
