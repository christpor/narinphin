...
export default function Expertise() {
  return <><Seo route="/expertise" /><PageHero number="02" eyebrow="Areas of practice" khmer="ជំនាញ និងការអនុវត្ត" title="The work of education is practical, precise, and deeply human." intro="A focused view of the skills Narin has developed across English teaching, curriculum work, academic leadership, and communication." khmerTitle="ការអប់រំ ត្រូវការភាពជាក់លាក់ ការយកចិត្តទុកដាក់ និងការយល់ពីមនុស្ស។" khmerIntro="ស្វែងយល់ពីជំនាញដែលគ្រូណារិន បានអភិវឌ្ឍក្នុងការបង្រៀន កម្មវិធីសិក្សា និងភាពជាអ្នកដឹកនាំ។" image={ASSETS.classroom} imageAlt="A teacher leading a small classroom discussion" />
